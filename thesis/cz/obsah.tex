...
\subsubsection{VALUE}
\verb|VALUE| je datový typ, který v C reprezentuje objekt. V ruby je v¹e objekt, tak¾e se tento datový typ pou¾ívá v¹ude - ka¾dá funkce, která je volatelná z ruby, vrací \verb|VALUE| jako svou návratovou hodnotu. Ve skuteènosti je se jedná o pøejmenování datového typu \verb|long|.
