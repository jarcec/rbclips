...
\chapter{Závìr}
%=========================================================================
Knihovnu rbClips jsem úspì¹nì naprogramoval a odzkou¹el na základì testù, které jsou souèástí knihovny. V souèasné dobì probíhá její dal¹í testovaní pro odhalení rùzných chyb, kterých jsem si pøi vlastním testování nev¹iml. Dal¹ím krokem bude pou¾ít knihovnu k tvorbì expertního systému v Ruby pro automatickou klasifikaci vzorkù, tak jak jsem zmínil v úvodu. 
