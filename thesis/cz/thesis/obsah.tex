...
CLIPS umo¾nuje vytváøet i takzvané neseøazené fakty, které se svým pojetím dají pøirovnat napøíklad ke strukturám v jazyce C. Stejnì jako ony mají svùj pøedem známy seznam mo¾ných polo¾ek, kterým se v terminologii CLIPS øíká sloty. Tento pøedpis se vytváøí pomocí ¹ablon. Knihovna rbClips zapouzdøuje ve¹kerou práci se ¹ablonami do tøídy \verb|Template|. Ka¾dý slot musí mít své jméno podle, kterého je jednoznaènì identifikován. Volitelnì poté mù¾e být navázán na \verb|Contrait| objekt popisující jeho omezení (napøíklad jaké datové typy smí obsahovat).

\subsection{Tøída Fact}
V CLIPS existují dva typy faktù, seøazené a neseøazené, které knihovna rbClips zapouzdøuje do jedné tøídy jménem Fact. Existuje sice jenom jedna tøída popisující fakt, ale její rozhraní (metody) se li¹í podle toho jaký typ instance tøídy popisuje. První bych rád popsal chování které je spoleèné v¹em instancím a poté popsal jednotlivé rozdíly u jednotlivých typù.
