...
%=========================================================================
Knihovna rbClips je výsledek mé bakaláøské práce. Jedná se o manuálnì napsané binární roz¹íøení pro Ruby, které zapouzdøuje práci s CLIPS.

K manuálnímu napsání rozhraní jsem se rozhodl z nìkolika dùvodù. 

\section{Implementacni patalie - zmenit}
Proc jsem se rozhodl pro manualni postup - moznost zapouzdrit libovolne struktury do ruby objektu - zrychleni
