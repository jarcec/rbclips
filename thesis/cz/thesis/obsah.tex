...
CLIPS umo¾nuje vytváøet i takzvané neseøazené fakty, které se svým pojetím dají pøirovnat napøíklad ke strukturám v jazyce C. Stejnì jako ony mají svùj pøedpis mo¾ných polo¾ek, které se v terminilogii CLIPS nazývají sloty. Tento pøedpis se v CLIPS vytváøí pomocí ¹ablon. Ve¹kerá práce se ¹ablonami je v rbClips zapouzdøena pomocí tøídy \verb|Template|.
