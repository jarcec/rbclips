...
CLIPS podobné jako mnoho dal¹ích expertních systémù pro reprezentaci pou¾íva pravidla typu kdy¾-tak (if-then).

\subsubsection{}

\subsubsection{Prostøedí v CLIPS}
Pro sna¾¹í oddìlenní více be¾ících instancí expertního systému umo¾nuje CLIPS vytváøet takzvaná prostøedí. Ka¾dé prostøedí obsahuje svou vlastní mno¾inu pravidel a faktù. 

\subsection{Roz¹iøitelnost}
Par slov k rozsiritelnosti, moznosti definovat vlastni uzivatelské funkce

\subsection{Reetùv algoritmus}
Popsat jak funguje.
