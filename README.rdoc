...
I'm supposing that you're already familiar with CLIPS tool and it's user interface. Interface of rbClips have similar approach as ActiveRecord project.
...
Documentation can be build from source codes using {Doxygen tool}[http://www.stack.nl/~dimitri/doxygen/].
